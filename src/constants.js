...
var GlobalConst = {
	...
	// ------------------------------------------------------------------------
	DEBUG: "none",    // ALL, GEOM, I18N, LAYERS, WMS, DISENG_WHEEL, AGSMAP, AGSQRY, AGSIMAGE, IMGLOAD, VECTLOAD, RISCOFEATS, FEATMOUSESEL, INTERACTION, INTERACTIONCLICKEND, INTERACTIONCLEAR, INTERACTIONOUT, TOOLENABLE, DYNSYMBOLOGY, DRAWASSELECTED, JSONFG, SAVERESULT, none
	...
	CONTROLS_STYLES: {
		...
		TOC_STRIKETHROUGH_FILL: "rgba(200, 200, 200, 0.4)",
		TOC_STRIKETHROUGH_WIDTH: 16,
